...
function bringSearchToLife(el) {
  ...
  async function handleChange(e) {
    ...
    const resultPromise = await fetch(`/wp-json/wp/v2/posts?search=${ourCleanValue}`);
...
function generateHTML(results) {
  ...
  return dompurify__WEBPACK_IMPORTED_MODULE_0__["default"].sanitize(bigHTML);
}
})();
